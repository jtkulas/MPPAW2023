...
--
.pull-left[
I have 28 programs <br>(I currently use to navigate my job)
]
--
.pull-right[
I have a 1 (free) platform <br>(to rule them all)
]

--

.pull-left[![](img/microsoft.png)]
.pull-right[![](img/R.JPG)]
...
#.fancy[`r fa("r-project", fill="#4287f5")` is an *operating environment*:]
