...
--
.pull-left[
I have a statistical program <br>(I currently use)
]
--
.pull-right[
I have a statistical program <br>(I'm gonna switch to)
]
...
##.fancy[It is actually a *multipurpose* operating environment]
...
# .fancy[The (recommended) broader perspective on `r fa("r-project", fill="#4287f5")`:]

--
.pull-left[
I have many platforms <br>(I currently use to navigate my job):<br>

<img src="img/word.png" width="100" height="100"  
style="position:absolute; left:70px; bottom:330px;">

<img src="img/excel.png" width="100" height="100"  
style="position:absolute; left:180px; bottom:330px;">

<img src="img/powerpoint.png" width="100" height="100"  
style="position:absolute; left:290px; bottom:330px;">

<img src="img/spss_solo.png" width="100" height="100"  
style="position:absolute; left:400px; bottom:330px;">

<img src="img/powerbi.png" width="100" height="100"  
style="position:absolute; left:500px; bottom:330px;">

]
--
.pull-right[
I have a 1 (free) platform <br>(to rule them all):  <br>
<img src="img/R.png"
...
# .fancy[Our *recommended orientation shift*:]
