...
.large[To build plots and graphs, we will use `R` script. To add a new chunk, we will hit the `plus C` green button:]
...
.large[Next, we will add the `R` commands that will create our visualization:] <br>\*Note that you will be *provided* `R` commands within the breakout sessions (if you'd like)

![](img/Website/script.jpg)
---
class: left, top, inverse

# A little closer look at that chunk...
