...
Quarto actually an independent platform. There is a Quarto `r fa("r-project", fill="#4287f5")` package, but it mostly provides shortcuts for control-line commands. Markdown only launched in 2004 - this seems like a natural evolution (makes html & pdf output more seamless - also language agnostic)
